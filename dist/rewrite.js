...
export const mkAliasRewriter = (fromPrefix = "@old", toPrefix = "@new-") => (spec) => {
...
const toJs = (s) => /\.[mc]?tsx?$/.test(s) ? s.replace(/\.[mc]?tsx?$/i, ".js") : `${s}.js`;
const tryIndex = (absNoExt) => {
...
export const mkRelativeToJs = (fromFile) => (spec) => {
